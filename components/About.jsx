        ...
        className='lg:basis-2/4'>
          <h1 className='text-lg pb-4 flex flex-row text-white'>
            ...
            <p className='text-xs leading-loose text-white' >
              ...
              I participated in <span className='underline'> <a href='https://www.credential.net/d1fa80d5-d6c9-4c2c-9578-0dd30a00c312' className='visited:text-purple-400' target='_blank'>Re:Coded's</a></span> front-end development bootcamp where I learned multiple tech and soft skills.<br></br>
              I am constantly exploring new frameworks & libraries as well as looking for opportunities to grow as a developer.<br></br>
