     ...
     <div  className= 'grid md:grid-cols-2 md:grid-rows-1 pt-5 pb-5 text-xs'> 
      ...
      If you want to collaborate, have questions, or would love to chat,
       please get in touch using this form or through my social links below
        ...
        <input onChange={(e)=>handleNameChange(e)} className="text-white" type="text" name="from_name" required/>
       <span className='text-red-700'>{userName !== "" ? <></>:'What can I call you?'}</span>
        ...
        <input onChange={(e)=>handleEmailChange(e)} className="text-white" type="email" name="reply_to" required />
        ...
        <textarea onChange={(e)=>handleTextChange(e)} className="text-white"  name="message"required />
        <input 
